...
namespace Caelicus.Simulation
{
    public class Simulation
    {
        ...
        {
            progress.Report(new SimulationProgress(_parameters.SimulationIdentifier, $"Starting simulation with  { _parameters.Vehicles.First().Name } vehicles"));
            ...
            while (!simulator.IsDone())
            {
                ...
                {
                    progress.Report(new SimulationProgress(_parameters.SimulationIdentifier, $"Stopped simulation with { _parameters.Vehicles.First().Name } vehicles"));
                    throw new TaskCanceledException();
                }

            }
            progress.Report(new SimulationProgress(_parameters.SimulationIdentifier, $"Finished simulation with { _parameters.Vehicles.First().Name } vehicles"));
